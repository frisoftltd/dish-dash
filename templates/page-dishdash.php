 ...
 *
 * A complete standalone page template that replaces
 * the theme header/footer with Dish Dash branding.
 *
 * To use: Edit any WordPress page → Page Attributes
 * → Template → select "Dish Dash Full Page"
 */
...
<header class="dd-header">
    <div class="dd-header__inner">
        ...
        <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="dd-header__logo">
            ...
            <?php else : ?>
                <span class="dd-header__logo-text">
        ...
        <div class="dd-hero__content">
            ...
            <div class="dd-hero__search">
                <input type="search"
                       ...
                       autocomplete="off" />
                <button class="dd-hero__search-btn">🔍</button>
            </div>
        </div>
...
<footer class="dd-footer">
    <div class="dd-footer__inner">
        ...
        <div class="dd-footer__col">
            ...
            <p>✉️ <a href="mailto:<?php echo esc_attr( $email_contact ); ?>"><?php echo esc_html( $email_contact ); ?></a></p>
            <?php endif; ?>
        ...
        <div class="dd-footer__col">
            ...
            <ul>
                ...
                <?php if ( dd_is_enabled( 'reservations' ) ) : ?>
        ...
        <div class="dd-footer__col">
            ...
            <div class="dd-footer__social">
                <?php if ( $facebook ) : ?>
                <a href="<?php echo esc_url( $facebook ); ?>" target="_blank" class="dd-social-btn dd-social-btn--fb">f</a>
                <?php endif; ?>
                <?php if ( $instagram ) : ?>
                <a href="<?php echo esc_url( $instagram ); ?>" target="_blank" class="dd-social-btn dd-social-btn--ig">📷</a>
                <?php endif; ?>
                <?php if ( $whatsapp ) : ?>
                <a href="https://wa.me/<?php echo esc_attr( $whatsapp ); ?>" target="_blank" class="dd-social-btn dd-social-btn--wa">💬</a>
                <?php endif; ?>
            </div>
        </div>
