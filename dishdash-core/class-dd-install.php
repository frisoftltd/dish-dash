...
class DD_Install {
    ...
    private static function set_defaults(): void {
        $defaults = [
            ...
            'dd_google_maps_key'                 => '',
            'dd_claude_api_key'                  => '',
            'dd_reservation_deposit_enabled'     => '0',
            'dd_reservation_deposit_type'        => 'fixed',
            'dd_reservation_deposit_amount'      => '2000',
            'dd_reservation_autocancel_hours'    => '2',
            'dd_reservation_refund_enabled'      => '0',
            'dd_reservation_refund_hours'        => '24',
            'dd_reservation_refund_policy_text'  => '',
        ];
