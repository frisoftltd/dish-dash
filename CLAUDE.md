...
>
> Last updated: v3.10.67 (2026-07-16)
...
| Field | Value |
|---|---|
| **Deployed version** | v3.10.67 |
| **Current phase** | Phase 7 — Role Cleanup & Access Control |
| **Current sub-phase** | Footer / white-label readiness (investigation `investigation.md`). v3.10.67 = fix opening-hours two-writer collision. NEXT: v3.10.68 = wire the dead `dd_footer_show_*` toggles |
