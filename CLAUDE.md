...
>
> Last updated: v3.10.66 (2026-07-16)
...
| Field | Value |
|---|---|
| **Deployed version** | v3.10.66 |
| **Current phase** | Phase 7 — Role Cleanup & Access Control |
| **Current sub-phase** | Reservation Track — ✅ COMPLETE (R1–R6 = v3.10.58–65) + admin "Mark deposit paid" control (v3.10.66, closes the deposit loop) |
