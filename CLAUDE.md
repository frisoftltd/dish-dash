...
>
> Last updated: v3.10.68 (2026-07-16)
...
| Field | Value |
|---|---|
| **Deployed version** | v3.10.68 |
| **Current phase** | Phase 7 — Role Cleanup & Access Control |
| **Current sub-phase** | Footer / white-label readiness (investigation `investigation.md`). v3.10.67 = opening-hours two-writer fix. v3.10.68 = wire the footer column toggles. Remaining white-label items (from investigation §D1): hardcoded "Khana Khazana" in order message + notification emails; hardcoded hero pill "Authentic Indian Dining"; Explore literals; copyright "Built by Fri Soft Ltd" (no toggle) — all deferred |
