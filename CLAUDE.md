...
>
> Last updated: v3.4.63 (2026-05-27)
...
| **Next task** | v3.4.64 — Tables + Seating Sections redesign |
| **Last working state** | Top Items all-time query; stale banner bulk deliver button; recent orders rows clickable (links to orders filtered by status). |
...
| v3.4.64 | ⏳ **NEXT** | Tables + Seating Sections redesign |
