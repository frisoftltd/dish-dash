...
>
> Last updated: v3.10.8 (2026-06-23)
...
| Field | Value |
|---|---|
| **Deployed version** | v3.10.8 |
| **Current phase** | Phase 7 — Role Cleanup & Access Control |
| **Current sub-phase** | Phase 7C — Customer Profile |
| **Next task** | v3.10.9 — Phase 7C next |
| **Last working state** | v3.10.8: Fixed all payment method logos not loading — pluginUrl was missing from ddCartData (now added via plugins_url). Added pesapal to $icon_urls in PHP. Fixed &amp; HTML entity in gateway titles via html_entity_decode(). Removed JS logoMap (was overriding correct PHP absolute URLs with broken relative paths). Added overflow-y:auto to .dd-cart-panel (scroll for PesaPal panel). Added .dd-payment-methods-wrap scroll indicator. |
