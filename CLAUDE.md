...
>
> Last updated: v3.10.54 (2026-07-14)
...
| v3.10.55 | ⏳ | R6 — render dynamic MoMo QR (`tel:*182*8*1*{merchant}*{amount}%23`) + iOS copy fallback (merchant-code gated) |
| v3.10.56 | ⏳ | R7 — single-tap "I have paid" → flip `payment_status='claimed'` + open WhatsApp ticket |
