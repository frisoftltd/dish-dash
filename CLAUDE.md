...
>
> Last updated: v3.5.32 (2026-06-09)
...
| **Next task** | v3.5.33 — TBD |
| **Last working state** | v3.5.32: menu page tablet fix — raised menu-page.css breakpoints (767px→1024px, 768px→1025px ×3, 901px→1025px) and menu-page.js innerWidth check (768→1025) so iPad Air 5 at 820px gets the full mobile 3-screen app instead of unstyled desktop HTML. |
