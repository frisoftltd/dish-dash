...
>
> Last updated: v3.5.15 (2026-06-07)
...
| **Next task** | v3.5.16 — TBD |
| **Last working state** | Dashicons color fix: .dd-res-header .dashicons { color: #fff } added to reservations-admin.css so icons are visible on dark header. |
