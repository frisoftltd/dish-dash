...
>
> Last updated: v3.5.14 (2026-06-07)
...
| **Next task** | v3.5.15 — TBD |
| **Last working state** | Dashicons explicitly enqueued on all three reservations admin pages (Reservations, Tables, Seating Sections). |
